...
if __name__ == '__main__':
    ...
    aoe2_params = get_aoe2_net_parameters(timeout=max_time_request)
    print('AoE2 parameters:', aoe2_params)

    stop_flag = Event()  # stop event: setting to True to stop the thread
    out_data = []
    thread_id = get_aoe2_net_match_data_threading(out_data, stop_event=stop_flag, search_input=player_name,
                                                  timeout=max_time_request, aoe2_net_parameters=aoe2_params)
