...
class AoE4ConfigurationLayout:
    ...
    def __init__(self, ):
        ...
        self.bo_list_max_count: int = 5  # maximum count of valid build orders in the selection list
    ...
    def to_dict(self):
        ...
        data['flag_select_size'] = self.flag_select_size
    ...
    def from_dict(self, data):
        ...
        self.flag_select_size = data['flag_select_size']
...
class AoE4MatchDataLayout:
    ...
    def to_dict(self):
        ...
        data['rank_class_height'] = self.rank_class_height
        data['resource_spacing'] = self.resource_spacing
    ...
    def from_dict(self, data):
        ...
        self.rank_class_height = data['rank_class_height']
        self.resource_spacing = data['resource_spacing']
