...
* [Age of Empires IV](https://www.ageofempires.com/games/age-of-empires-iv/)
    ...
    * Show match data with the player main statistics.
    * [DOWNLOAD HERE](https://github.com/CraftySalamander/RTS_Overlay/releases/download/1.5.3/aoe4_overlay.zip) (Windows only) or run the program with python scripts (see **Python configuration** section).
...
* [StarCraft II](https://starcraft2.com)
    ...
    * [DOWNLOAD HERE](https://github.com/CraftySalamander/RTS_Overlay/releases/download/1.5.0/sc2_overlay.zip) (Windows only) or run the program with python scripts (see **Python configuration** section).
...
5. Create the Conda environment: `conda create --name rts_overlay --file requirements_small.txt` (you can use `requirements.txt` if you want to have the specific libraries versions).
6. Activate your environment: `conda activate rts_overlay`
7. Run the application: `python aoe2_overlay.py` (for AoE2, similar for other games).

Steps 3, 4, 6 and 7 must be re-done each time you want to launch the program.
