...
* Using an EXE (or running from its Python source code)
    ...
    * Download the EXE (only for Windows) using these links:
        * [Age of Empires II](https://github.com/CraftySalamander/RTS_Overlay/releases/download/2.12.0/aoe2_overlay.zip)
        * [Age of Empires IV](https://github.com/CraftySalamander/RTS_Overlay/releases/download/2.12.0/aoe4_overlay.zip)
        * [Age of Mythology](https://github.com/CraftySalamander/RTS_Overlay/releases/download/2.11.0/aom_overlay.zip)
        * [Starcraft II](https://github.com/CraftySalamander/RTS_Overlay/releases/download/2.11.1/sc2_overlay.zip)
